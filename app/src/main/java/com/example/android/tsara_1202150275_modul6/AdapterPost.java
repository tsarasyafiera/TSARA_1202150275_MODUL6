...
public class AdapterPost extends  RecyclerView.Adapter<AdapterPost.PostViewHolder>{
    ...
    public AdapterPost(List<DBPost> list, Context cntx) {
        this.list = list;
        this.cntx = cntx;
    }
    ...
    public PostViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new PostViewHolder(LayoutInflater.from(cntx).inflate(R.layout.rec_feed, parent, false));
    }
    ...
    public void onBindViewHolder(PostViewHolder holder, int position) {
        ...
        Glide.with(cntx).load(current.getImage()).placeholder(R.drawable.add_image).override(450, 450).into(holder.image);
    }
        ...
        public PostViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent pindah = new Intent(cntx, post.class);
